...
#b = panda(position = P3(1,1,integral(2)), hpr = HPR(integral(2),-.75,0), size = 0.05)
#c = panda(position = P3(sin(integral(.2)),5+integral(5),cos(integral(.2))), hpr = HPR(integral(1),integral(.5),integral(1)))
