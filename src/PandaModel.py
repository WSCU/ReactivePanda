...
def pandaModel(fileName = None, name = "PandaModel", size = None, hpr = None, position = None, collections = [], color = None, texture = None):
    return PandaModel(  fileName, size, hpr, position, collections, color, texture, name)

class PandaModel(Proxy):
    def __init__(self, fileName, size, hpr, position, collections, color, texture, name):
