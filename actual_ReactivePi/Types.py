...
scalableType = ptype("scalable", subtypes = [numType])
interpableType = ptype("interp", subtypes = [numType])
addableType = ptype("addable", subtypes = [numType, stringType ])
...
def interpableType(t):
    return t is numType or t is boolType
